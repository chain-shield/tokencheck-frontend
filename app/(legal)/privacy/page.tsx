    ...
    >
      ...
      <article className="rounded-[1.75rem] bg-[#131313] p-8 shadow-[0_24px_60px_rgba(0,0,0,0.35)] ring-1 ring-white/10 md:p-10">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4">
            Welcome to ChainShield's smart contract security auditing service (the "Service"), available through our website <strong>chainshield.ai</strong> (the "Site"). This Privacy Policy explains how <strong>ChainShield</strong> ("<strong>ChainShield</strong>," "<strong>we</strong>," "<strong>us</strong>," or "<strong>our</strong>") collects, uses, shares, and protects your personal information when you use our Service. We are committed to protecting your privacy and using your data responsibly.
          </p>
          <p className="mb-4">
            You can request smart contract audits through our platform, which requires creating an account and submitting smart contract code for analysis. Accessing our API or enterprise features also requires you to create an account and log in, which involves providing certain information as described below. This Policy applies to all users of our Service, whether you use basic audit services or advanced features, and regardless of your location. By using the Site or Service, you agree to the terms of this Privacy Policy. If you do not agree, please refrain from using the Service.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4">
            When you create an account for our audit services, API access, or enterprise services (or if you contact us directly), we collect personal information such as your email address and any other details you choose to provide. Email addresses are required for account creation (e.g., to set up login credentials, verify your identity, and communicate with you). We also collect smart contract code and related documentation that you submit for security auditing purposes.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2 mb-4">
            ...
            <li><strong>Usage Data:</strong> We collect data about your interactions with our Site, including the pages or screens you view, the features you use, audit requests you submit, the time and date of your visits, and the duration of your use. For example, we may track that a user submitted an audit request and how long it took to process. This usage information helps us understand how our Service is used and identify areas for improvement.</li>
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc pl-6 space-y-2 mb-4">
            <li><strong>Providing the Service:</strong> We use your information to provide and deliver the functionalities of our smart contract security auditing Service. For example, if you submit smart contract code for auditing, we use the code and related information to perform the security analysis and provide you with audit results. If you create an account, we use your email (and any login credentials or OAuth tokens) to authenticate you and allow you access to API or enterprise features.</li>
